...
resource "google_compute_project_metadata" "default" {
    ...
    metadata = {
        enable-oslogin  = "TRUE"
        "vpc-sc-multi-vpc${local.suffix}-cwd" = path.cwd
    }
}
...
resource "google_access_context_manager_service_perimeter" "service-perimeter" {
    ...
    name        = "accessPolicies/${google_access_context_manager_access_policy.access-policy.name}/servicePerimeters/perim${local.suffix_nodash}"
    title       = "Restrict APIs"
    status {
